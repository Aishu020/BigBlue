...
const Home = ({isAuthenticated})=> {
  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className={`navbar-header`}>
          ...
          <a className={`${styles.navbarBrand} navbar-brand`} href="#">BigBlue </a>
        </div>
      ...
      <div className={styles.bannerTitle}>
        ...
        <p className={styles.bannerLead}>BigBlue  is a high quality video calling app. It's free and works on the web.</p>
        <br/>
    ...
    <div className={styles.headline}>What can you do with BigBlue?</div>
    ...
    <div className={styles.reminder}>
      ...
      <Button title="Try BigBlue  Now" onClickHandler={onTryNowBtnClick}/>
    </div>
    <div className={styles.footer}>
    <a className={`${styles.navbarBrand}`} href="#">BigBlue </a>
